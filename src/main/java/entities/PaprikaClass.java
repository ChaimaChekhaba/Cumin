...
public class PaprikaClass extends Entity{
    ...
    //list of metrics related to MVC-based architectural patterns
    private int numberOfGUIComponents;
    private int numberOfGUIStatements;
    private int numberOfInputEventListeners;
    private int numberOfLifecycleEvents;
    private int numberOfNonLifecycleEvents;
    private boolean isModel;
    private boolean isViewModel;
    private boolean hasDataTagInLayoutFile;
    private int handleInputEventsInXMLFile;
    private boolean doesUseDatabinding;
    ...
    private PaprikaClass(String name, PaprikaApp paprikaApp, PaprikaModifiers modifier) {
        ...
        complexity=0;
        numberOfGUIComponents=0;
        numberOfGUIStatements=0;
        numberOfInputEventListeners=0;
        numberOfInputEventListeners=0;
        numberOfLifecycleEvents=0;
        numberOfNonLifecycleEvents=0;
        isModel=false;
        isViewModel=false;
        hasDataTagInLayoutFile=false;
        handleInputEventsInXMLFile=0;
        doesUseDatabinding=false;
    ...
    //methods added by chaima for MVC-based pattern detection
    ...
    public int getNumberOfGUIComponents() {
    	return numberOfGUIComponents;
    }
    
    public void setNumberOfGUIComponents(int numberOfGUIComponents) {
    	this.numberOfGUIComponents = numberOfGUIComponents;
    }

    public void setNumberOfGUIStatements(int numberOfGUIStatements) {
    	this.numberOfGUIStatements = numberOfGUIStatements;
    }
    public int getNumberOfGUIStatements() {
    	return this.numberOfGUIStatements;
    }
	...
	public int getNumberOfInputEventListeners() {
    	return numberOfInputEventListeners;
    }
    public void setNumberOfInputEventListeners(int numberOfInputEventListeners) {
    	this.numberOfInputEventListeners = numberOfInputEventListeners;
    }
    public int getLifecycleEvents() {
    	return numberOfLifecycleEvents;
    }
    public void setLifecycleEvents(int lifecycleEvents) {
    	this.numberOfLifecycleEvents = lifecycleEvents;
    }

    public int getNonLifecycleEvents() {
    	return numberOfNonLifecycleEvents;
    }
    public void setNonLifecycleEvents(int NonLifecycleEvents) {
    	this.numberOfNonLifecycleEvents = NonLifecycleEvents;
    }
    ...
    public void setViewModel(boolean isModel) {
    	this.isViewModel = isModel;
    }
    public boolean isViewModel() {
    	return this.isViewModel;
    }
    public boolean hasDataTagInLayoutFile() {
    	return this.hasDataTagInLayoutFile;
    }
    public void setDataTagInLayoutFile(boolean hasDataTagInLayoutFile) {
    	this.hasDataTagInLayoutFile = hasDataTagInLayoutFile;
    }
    public int getHandleInputEventsInXMLFile() {
    	return this.handleInputEventsInXMLFile;
    }
    public void SetHandleInputEventsInXMLFile(int handleInputEventsInXMLFile) {
    	this.handleInputEventsInXMLFile = handleInputEventsInXMLFile;
    }
    public boolean doesUseDatabinding() {
    	return this.doesUseDatabinding;
    }
    public void setUseDatabinding(boolean doesUseDatabinding) {
    	this.doesUseDatabinding = doesUseDatabinding;
    }
}
